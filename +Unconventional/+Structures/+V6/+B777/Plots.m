...
adp_nf.Mf_Fuel = 0;
adp_nf.Mf_res  = 0;
G_nf = Unconventional.Structures.V6.B777.WingGeometry(adp_nf, tlar, loc);
L_nf = Unconventional.Structures.V6.B777.LoadDistribution(adp_nf, tlar, loc, G_nf, lc);
S_nf = Unconventional.Structures.V6.B777.SMT(loc, G_nf, L_nf);
