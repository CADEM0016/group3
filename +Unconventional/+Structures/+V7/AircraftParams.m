...
% Contains ONLY values that do not exist in any global file (ADP, TLAR,
% SI, cast.atmos, geom.constants) or any +Unconventional file.

% Wing planform  (not in any global file) ---------------------------------
...
% Wingbox  (not in any global file) ---------------------------------------
...
% Engine sizing  (not in any global file) ---------------------------------
loc.T_static_each = 513e3; % N   GE90-115B class
loc.m_engine_each = 8762;  % kg

% CS-25 load factors  (not in any global file) ----------------------------
...
% Aluminium 7075-T6  (not in any global file) -----------------------------
loc.Al.E         = 71.0e9;  % Pa
loc.Al.G         = 26.9e9;  % Pa
loc.Al.nu        = 0.33;
...
% CFRP quasi-isotropic  E = 3/8 E_uni (not in any global file) -----------
...
% Mass allowances  (not in any global file) -------------------------------
...
% Discretisation  (not in any global file) --------------------------------
loc.N_stations = 150;
