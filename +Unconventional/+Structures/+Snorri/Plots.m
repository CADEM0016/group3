...
p_nf.M_fuel   = 0;
p_nf.Mf_fuel  = 0;
G_nf = Unconventional.Structures.Snorri.WingGeometry(p_nf);
L_nf = Unconventional.Structures.Snorri.LoadDistribution(p_nf, G_nf, lc);
S_nf = Unconventional.Structures.Snorri.SMT(p_nf, G_nf, L_nf);
